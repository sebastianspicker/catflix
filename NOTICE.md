...
The bundled visual assets are synthetic project-generated images and locally made derivatives. Their identities, SHA-256 checksums, creators, transformation history, and terms designation are recorded in [`src/catalogue/model/authoredScenes.ts`](src/catalogue/model/authoredScenes.ts) and summarized in [`assets/masters/PROVENANCE.md`](assets/masters/PROVENANCE.md). The authored catalogue designates these assets as subject to [OpenAI's Terms of Use](https://openai.com/policies/terms-of-use/), rather than the repository's MIT license.
