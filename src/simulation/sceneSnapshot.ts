...
export const sceneSnapshot = (sceneId: SceneId, score: SceneScore, elapsedMs: number, forcedRestUntilMs: number, actors: MutableActor[], soundEvents: SoundEvent[], frameEvents: SceneEvent[], pendingEvents: SceneEvent[], reminder: SceneSnapshot["reminder"]): SceneSnapshot => {
