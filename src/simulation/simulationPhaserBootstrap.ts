...
import type { PhaserSimulationRendererOptions } from "./simulationPhaserRenderer";
...
export async function createPhaserSimulationBootstrap(options: PhaserBootstrapOptions): Promise<PhaserSimulationBootstrap> {
  const [phaserModule, rendererModule] = await Promise.all([import("phaser"), import("./simulationPhaserRenderer")]);
