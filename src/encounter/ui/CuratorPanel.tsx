...
export function CuratorPanel({ manifests, onClose, onStart }: CuratorPanelProps) {
  ...
  return <div className="modal-backdrop" role="presentation"><section ref={dialogRef} className="curator-dialog" role="dialog" aria-modal="true" aria-labelledby="curator-title" tabIndex={-1}>
